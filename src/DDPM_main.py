...
# everything below is conditional on this being the file run
# so in the case of this file being imported
# the only thing that happens is the function definition as above
